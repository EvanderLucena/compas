...
import com.compas.api.service.WebhookService;
...
public class WebhookController {
    ...
    public WebhookController(
            ...
            @Value("${compas.webhook.secret:${nutriai.webhook.secret:}}") String webhookSecret) {
    ...
    public ResponseEntity<Void> receiveWebhook(
        ...
        com.compas.api.auth.TenantContext.setBypassRls(true);
        try {
            webhookService.processIncoming(payload);
        } finally {
            com.compas.api.auth.TenantContext.clear();
        }
